...
class VerifyOtpVC: UIViewController, VerifyOtpViewProtocol {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.otpBGView.applyGradient(colours: [UIColor(hexString: "#161a1a"), UIColor(hexString: "#000000") ], locations: [0,0.7])
        setData()
    }
    ...
    ///  Method to get entered otp string
...
extension VerifyOtpVC : UITextFieldDelegate, MyOTPTFDelegate {
    /// Textfield delegate to handle otp fields
