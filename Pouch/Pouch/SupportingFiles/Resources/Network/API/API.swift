...
class API {
    ...
    struct Name {
        ...
        static let cards_categories = "cards/categories"
        static let templates = "templates"
        static let templates_name = "cards/templates/name"
        static let cards_user_templates = "cards/user/templates"
        static let invitation_schedule = "invitation/schedule"
        static let profile_update = "profile/update"
        static let profile_updatefcm = "profile/updatefcm"
        static let profile_preferences_update = "profile/preferences/update"
        static let profile = "profile"
        static let logout = "logout"
        static let actuator_health = "actuator/health"
    ...
    struct keys {
        ...
        static let set_notification = "set_notification"
        static let set_notification_app = "set_notification_app"
    }
