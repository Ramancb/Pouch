...
class ApiHandler {
    ...
    static public func call<T>(isShowIndicator:Bool = true, timeoutInterval: TimeInterval = 20, apiName: String,id:String? = "", params: [String : Any] = [:], httpMethod: API.HttpMethod  = .GET, completion: @escaping (T?,String?) -> ()) where T: Mappable {
